...
{ config, ... }:
{
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      "$browser" = "brave";
      "$lock" = "hyprlock";
      "$w1" = ''hyprctl hyprpaper wallpaper "LVDS-1,~/Pictures/Wallpapers/nord_roads.png"'';
      "$w2" = ''hyprctl hyprpaper wallpaper "LVDS-1,~/Pictures/Wallpapers/nord_lake.png"'';
      "$w3" = ''hyprctl hyprpaper wallpaper "LVDS-1,~/Pictures/Wallpapers/nord_bridge.png"'';
      "$w4" = ''hyprctl hyprpaper wallpaper "LVDS-1,~/Pictures/Wallpapers/nixos.png"'';
      "$w5" = ''hyprctl hyprpaper wallpaper "LVDS-1,~/Pictures/Wallpapers/random.jpg"'';
      "$w6" = ''hyprctl hyprpaper wallpaper "LVDS-1,~/Pictures/Wallpapers/hut.jpg"'';
      "$w7" = ''hyprctl hyprpaper wallpaper "LVDS-1,~/Pictures/Wallpapers/car.jpg"'';
      "$w8" = ''hyprctl hyprpaper wallpaper "LVDS-1,~/Pictures/Wallpapers/sky.jpg"'';
      "$w9" = ''hyprctl hyprpaper wallpaper "LVDS-1,~/Pictures/Wallpapers/aesthetic_sword.jpg"'';
      "$w0" = ''hyprctl hyprpaper wallpaper "LVDS-1,~/Pictures/Wallpapers/gruvbox_dark.png"'';
      ...
      bind = [
        ...
        "$mainMod SHIFT, C, exec, pkill waybar && waybar"
	      ...
	      # hyprpaper
	      "$mainMod SHIFT, W, exec, $w1"
	      "$mainMod SHIFT, E, exec, $w2"
	      "$mainMod SHIFT, R, exec, $w3"
        "$mainMod SHIFT, T, exec, $w4"
        "$mainMod SHIFT, Y, exec, $w5"
        "$mainMod SHIFT, U, exec, $w6"
        "$mainMod SHIFT, I, exec, $w7"
        "$mainMod SHIFT, O, exec, $w8"
        "$mainMod SHIFT, P, exec, $w9"
	      "$mainMod SHIFT, Q, exec, $w0"
